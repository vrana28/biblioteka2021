...
class AutorTest {
	...
	void setUp() throws Exception {
		a = new Autor(); //sve sto je zajednicko ide u setUp, on se uvek izvrsava pre svakog testa
	}

	@AfterEach
	void tearDown() throws Exception {
		a = null; // uvek se izvrsava nakon svakog testa
	}

	// testiranje bez parametarskog konstruktora
	@Test
	void testAutor() {
		a = new Autor();
		assertNotNull(a);
	...
	@Test
	@DisplayName("Testira ako je uneto null umesto imena") //promena naziva imena
	void testSetImeNull() {
